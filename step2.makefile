...
all: $(foreach data, mayo geuvadis rosmap, jobs/step2-$(data)-qtl.txt.gz jobs/step2-$(data)-qtl-mult.txt.gz) jobs/step2-gtex-qtl-mult.txt.gz

long: $(foreach data, mayo geuvadis rosmap, jobs/step2-$(data)-qtl-long.txt.gz jobs/step2-$(data)-qtl-mult-long.txt.gz)
...
jobs/step2-geuvadis-qtl.txt.gz: $(LD)
	...
	qsub -P compbio_lab -o /dev/null -binding linear:1 -cwd -V -l h_vmem=8g -l h_rt=4:00:00 -b y -j y -N geuvadis_cis_eqtl -t 1-$$(zcat $@ | wc -l) ./run_jobs.sh $@
...
jobs/step2-mayo-qtl.txt.gz: $(LD)
	...
	qsub -P compbio_lab -o /dev/null -binding linear:1 -cwd -V -l h_vmem=8g -l h_rt=4:00:00 -b y -j y -N mayo_cis_eqtl -t 1-$$(zcat $@ | wc -l) ./run_jobs.sh $@
...
jobs/step2-rosmap-qtl.txt.gz: $(LD)
	...
	qsub -P compbio_lab -o /dev/null -binding linear:1 -cwd -V -l h_vmem=8g -l h_rt=4:00:00 -b y -j y -N rosmap_cis_eqtl -t 1-$$(zcat $@ | wc -l) ./run_jobs.sh $@
