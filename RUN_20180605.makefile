...
################################################################
table: $(foreach _trait, ukbb_ad_mat ukbb_ad_pat ukbb_moodswings ukbb_neuroticism pgc_scz pgc_mdd pgc_asd pgc_adhd pgc_ocd pgc_ptsd_civ_ea pgc_ptsd_mil_ea pgc_ptsd_all_ea igap_ad, result/20180605/obs/gene-$(_trait).txt.gz)
